/* ============================================================
   ICONS — Lucide Compatible SVG Icons for VersaBold WEB PRINCIPAL
   Only functional UI icons (no decorative card icons — those use images)
   ============================================================ */

window.ICONS = {
  /* Navigation & UI */
  menu: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="4" y1="6" x2="20" y2="6"></line><line x1="4" y1="12" x2="20" y2="12"></line><line x1="4" y1="18" x2="20" y2="18"></line></svg>`,
  ...
  whatsapp: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.272-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-9.746 9.798c0 2.659.735 5.264 2.128 7.577L2.129 21.824l8.227-2.158c2.215 1.201 4.708 1.835 7.261 1.835 5.43 0 9.746-4.232 9.746-9.841 0-2.63-.675-5.159-1.955-7.416-1.28-2.256-3.057-4.286-5.157-5.787-2.1-1.5-4.565-2.313-7.052-2.211z"/></svg>`,
...
/* ============================================================
   ICON HELPER — Injects width, height, and class into SVG
   ============================================================ */
